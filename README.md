...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/tiny-resonance-4aee
```

A live public deployment of this template is available at [https://tiny-resonance-4aee.templates.workers.dev](https://tiny-resonance-4aee.templates.workers.dev)
